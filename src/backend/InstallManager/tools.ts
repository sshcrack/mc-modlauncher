...
export async function pngToIco(buff: Buffer) {
...
type imageType = Awaited<ReturnType<typeof Jimp.read>>;
function imagesToIco(images: imageType[]) {
...
function getDir(img: imageType, offset: number) {
...
function getBmpInfoHeader(img: imageType) {
