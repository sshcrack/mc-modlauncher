...
const logger = renderLogger_1.RenderLogger.get("Preload", "Buttons");
...
function addButtonAction(id, btn, installed, config) {
    btn.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (installed && newestVersion) {
            ...
            yield launcher.launch(id, config);
        ...
        prom
            ...
            .finally(() => (0, modpack_1.updateModpacks)(true));
    }));
}
...
function getButtonDiv(id, installed, config) {
    ...
    removeElement === null || removeElement === void 0 ? void 0 : removeElement.addEventListener("click", () => {
        ...
        modpack.remove(id)
            .catch(e => {
            var _a, _b;
            const str = (_b = (_a = e === null || e === void 0 ? void 0 : e.stack) !== null && _a !== void 0 ? _a : e === null || e === void 0 ? void 0 : e.message) !== null && _b !== void 0 ? _b : e;
            logger.error(str);
