...
const logger = mainLogger_1.MainLogger.get("InstallManager", "base", "Downloader");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const generateDownload = (retryStream) => {
                return new Promise(resolve => {
                    const stream = retryStream !== null && retryStream !== void 0 ? retryStream : source_1.default.stream(url);
                    if (writeStream)
                        writeStream.destroy();
